...
Shader "3dArthings/LWRP/MatcapFakePBR/Advanced/BlendTintColor"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_68_0 = ( tex2DNode69 + float4( WorldNormal , 0.0 ) );
				...
				float3 Albedo = temp_output_62_0.rgb;
				float3 Normal = NormalTexture70.rgb;
