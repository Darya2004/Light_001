...
Shader "3dArthings/LWRP/MatcapFakePBR/Advanced/BlendLerpColor"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _AOMap;
			sampler2D _MainTexture01;
			sampler2D _NormalMap;
			sampler2D _MainTexture02;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult68 = lerp( tex2D( _MainTexture01, ( ( mul( UNITY_MATRIX_V, ( tex2DNode51 + float4( WorldNormal , 0.0 ) ) ) * 0.5 ) + 0.5 ).rg ) , tex2D( _MainTexture02, ( ( mul( UNITY_MATRIX_V, ( tex2DNode51 + float4( WorldNormal , 0.0 ) ) ) * 0.5 ) + 0.5 ).rg ) , _BLEND);
