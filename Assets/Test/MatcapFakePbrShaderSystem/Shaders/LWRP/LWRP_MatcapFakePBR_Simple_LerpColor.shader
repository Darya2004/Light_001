...
Shader "3dArthings/LWRP/MatcapFakePBR/Simple/LerpColor"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 desaturateInitialColor27 = tex2D( _MainTexture, ( ( mul( UNITY_MATRIX_V, float4( WorldNormal , 0.0 ) ).xyz * 0.5 ) + 0.5 ).xy ).rgb;
				...
				float3 Albedo = lerpResult31.rgb;
